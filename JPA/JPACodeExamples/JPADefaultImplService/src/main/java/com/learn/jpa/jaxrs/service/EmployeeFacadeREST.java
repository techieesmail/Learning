 ...
 */
package com.learn.jpa.jaxrs.service;
 ...
 */
@Stateless
@Path("com.learn.jpa.entities.employee")
public class EmployeeFacadeREST extends AbstractFacade<Employee> {

    @PersistenceContext(unitName = "com.learn.jpa_JPADefaultImplService_war_1.0-SNAPSHOTPU")
