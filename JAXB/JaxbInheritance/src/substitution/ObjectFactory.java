 ...
 * generated in the substitution package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: substitution
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "phoneNumber", substitutionHeadNamespace = "", substitutionHeadName = "contactInfo")
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "address", substitutionHeadNamespace = "", substitutionHeadName = "contactInfo")
