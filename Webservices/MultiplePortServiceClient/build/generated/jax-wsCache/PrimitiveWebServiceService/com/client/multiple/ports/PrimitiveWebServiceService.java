 ...
 * 
 */
@WebServiceClient(name = "PrimitiveWebServiceService", targetNamespace = "http://service.base.com/", wsdlLocation = "http://[2002:7c7b:3f44:0:0:0:7c7b:3f44]:7001/MultiplePortService/PrimitiveWebServiceService?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://[2002:7c7b:3f44:0:0:0:7c7b:3f44]:7001/MultiplePortService/PrimitiveWebServiceService?WSDL");
    ...
    public PrimitiveWebServiceService(WebServiceFeature... features) {
        super(__getWsdlLocation(), PRIMITIVEWEBSERVICESERVICE_QNAME, features);
    }

    public PrimitiveWebServiceService(URL wsdlLocation) {
        super(wsdlLocation, PRIMITIVEWEBSERVICESERVICE_QNAME);
    }

    public PrimitiveWebServiceService(URL wsdlLocation, WebServiceFeature... features) {
        super(wsdlLocation, PRIMITIVEWEBSERVICESERVICE_QNAME, features);
    }
    ...
    public PrimitiveWebServiceService(URL wsdlLocation, QName serviceName, WebServiceFeature... features) {
